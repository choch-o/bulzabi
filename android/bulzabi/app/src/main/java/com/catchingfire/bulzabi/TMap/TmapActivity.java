package com.catchingfire.bulzabi.TMap;
...
import com.catchingfire.bulzabi.LogManager;
import com.catchingfire.bulzabi.R;
...
public class TmapActivity extends BaseActivity implements onLocationChangedCallback
{
	...
	public static String mApiKey = "8881c9b4-0385-3156-aaed-f2040d0c0887"; // 발급받은 appKey
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_tmap_main);
